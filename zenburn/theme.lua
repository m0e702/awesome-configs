...
--theme.taglist_text_font = "kane890 10"
-- theme.taglist_text_empty    =  {"one","","","","","","","",""}
-- theme.taglist_text_occupied =  {"hello","","","","","","","",""}
-- theme.taglist_text_focused  = {"one","","","","","","","",""}
-- theme.taglist_text_urgent   = {"hello","","","","","","","",""}

theme.taglist_text_empty    = {"", "helo", "fuck", "tit", "", "", "", "", ""}
theme.taglist_text_occupied = {"hello", "tit", "tiit", "tits", "tuts", "", "", "", ""}
theme.taglist_text_focused  = {"hello", "", "", "", "", "", "", "", ""}
theme.taglist_text_urgent   = {"hello", "", "", "", "", "", "", "", ""}

 theme.taglist_font = "kane890 17"
